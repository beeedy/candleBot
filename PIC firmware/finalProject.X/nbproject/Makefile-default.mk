...
${OBJECTDIR}/_ext/1472/wiiCams.p1: ../wiiCams.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1472" 
	@${RM} ${OBJECTDIR}/_ext/1472/wiiCams.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1472/wiiCams.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/1472/wiiCams.p1  ../wiiCams.c 
	@-${MV} ${OBJECTDIR}/_ext/1472/wiiCams.d ${OBJECTDIR}/_ext/1472/wiiCams.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1472/wiiCams.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
