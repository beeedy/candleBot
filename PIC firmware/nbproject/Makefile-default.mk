...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Source_Code.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=LCD.c main.c delays.c encoders.c whiskers.c UART.c FONA.c settings.c fft.c motorDrive.c PS2.c compass.c colorSensor.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/delays.p1 ${OBJECTDIR}/encoders.p1 ${OBJECTDIR}/whiskers.p1 ${OBJECTDIR}/UART.p1 ${OBJECTDIR}/FONA.p1 ${OBJECTDIR}/settings.p1 ${OBJECTDIR}/fft.p1 ${OBJECTDIR}/motorDrive.p1 ${OBJECTDIR}/PS2.p1 ${OBJECTDIR}/compass.p1 ${OBJECTDIR}/colorSensor.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/LCD.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/delays.p1.d ${OBJECTDIR}/encoders.p1.d ${OBJECTDIR}/whiskers.p1.d ${OBJECTDIR}/UART.p1.d ${OBJECTDIR}/FONA.p1.d ${OBJECTDIR}/settings.p1.d ${OBJECTDIR}/fft.p1.d ${OBJECTDIR}/motorDrive.p1.d ${OBJECTDIR}/PS2.p1.d ${OBJECTDIR}/compass.p1.d ${OBJECTDIR}/colorSensor.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/delays.p1 ${OBJECTDIR}/encoders.p1 ${OBJECTDIR}/whiskers.p1 ${OBJECTDIR}/UART.p1 ${OBJECTDIR}/FONA.p1 ${OBJECTDIR}/settings.p1 ${OBJECTDIR}/fft.p1 ${OBJECTDIR}/motorDrive.p1 ${OBJECTDIR}/PS2.p1 ${OBJECTDIR}/compass.p1 ${OBJECTDIR}/colorSensor.p1

# Source Files
SOURCEFILES=LCD.c main.c delays.c encoders.c whiskers.c UART.c FONA.c settings.c fft.c motorDrive.c PS2.c compass.c colorSensor.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Source_Code.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Source_Code.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Source_Code.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        -odist/${CND_CONF}/${IMAGE_TYPE}/Source_Code.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/Source_Code.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Source_Code.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Source_Code.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -odist/${CND_CONF}/${IMAGE_TYPE}/Source_Code.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
